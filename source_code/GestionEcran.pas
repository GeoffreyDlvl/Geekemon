...
interface
  ...
  procedure readlnE(); //indique à l'utilisateur qu'il doit appuyer sur entrée pour afficher le texte suivant
...
implementation
  ...
  procedure couleurTexte(couleur : Byte);
    ...
    procedure readlnE();
    var
      coordCurs : coordonnees;
    begin
      couleurTexte(7);
      write('[ ]');
      coordCurs := positionCurseur();
      coordCurs.x := coordCurs.x-2;
      coordCurs.y := coordCurs.y;
      deplacerCurseur(coordCurs);
      couleurTexte(15);
      readln;
      coordCurs.x := coordCurs.x-1 ;
      ecrireEnPosition(coordCurs, '   ');
      writeln;
    end;
